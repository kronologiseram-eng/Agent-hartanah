...
const socialLinks: SocialLink[] = [
  ...
  {
    label: "TikTok",
    href: "https://tiktok.com/@azlansyafiq",
    icon: <TikTokIcon />,
  ...
  {
    label: "Instagram",
    href: "https://instagram.com/azlansyafiq",
    icon: <InstagramIcon />,
  ...
  {
    label: "LinkedIn",
    href: "https://linkedin.com/in/azlansyafiq",
    icon: <LinkedInIcon />,
    ...
    >
        ...
        {socialLinks.map((social, index) => (
          <motion.a
            ...
            className={`
              ...
              ${social.hoverColor} ${social.bgColor}
            `}
          >
      ...
      >
        ...
        <div className="flex-1 min-w-0">
          ...
          <p className="text-[10px] text-slate-400 truncate">
            Dipercayai 150+ pembeli & pelabur hartanah
          </p>
        </div>
      ...
      <div className="text-center space-y-1.5">
        <p className="text-[10px] text-slate-600">
          © 2024 Azlan Syafiq. Hak Cipta Terpelihara.
        </p>
        ...
        <div className="flex items-center justify-center gap-1.5 mt-2">
          ...
          <p className="text-[9px] text-slate-600">
            Lesen REN aktif & sah di bawah LPPEH Malaysia
          </p>
        </div>
      </div>
    </motion.footer>
